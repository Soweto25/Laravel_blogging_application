...
Route::post('/admin/login',[AdminController::class,'submit_login'])->middleware('guest');
Route::post('/admin/register', [AdminController::class, 'register']);

Route::post('/admin/register_save',[AdminController::class,'add_admin'])->middleware('guest');
