...
class HomeController extends Controller
{
    ...
    function detail(Request $request,$slug,$postId){
    	...
    	return view('detail',['detail'=>$detail, 'recent_posts' => $recent_posts, 'popular_posts'=>$popular_posts, 'comments'=>$comments, 'users' =>$users]);
    }
    ...
    function save_post_form(){
        $cats=Category::all();
        $recent_posts = Post::orderBy('created_at', 'desc')->take(5)->get();
        return view('save-post-form',['cats'=>$cats, 'recent_posts' => $recent_posts]);
    }
    ...
    function manage_posts(Request $request){
        ...
        $recent_posts = Post::orderBy('created_at', 'desc')->take(5)->get();
        return view('manage-posts',['data'=>$posts, 'recent_posts' => $recent_posts]);
    }
